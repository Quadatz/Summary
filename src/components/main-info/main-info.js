    ...
    return (
        <div className="main-info">
            ...
            <div className="main-info__descr">
                <p>Как вы меня уже поняли, меня зовут Роман, мне 15 лет, я начинающий Front-End разработчик из города <b>Ростов-на-Дону.</b></p>
                <p>Учусь разработке <b>уже более года</b>, сливы платных курсов, видео в ютубе и документация мои лучшие друзья.</p>
                <p>Ценю в себе <b>очень быструю обучаемость</b>, <b>быстро учусь на ошибках</b>. Хочу попасть в небольшую команду, мотивирован к обучению и карьерному росту)</p>
